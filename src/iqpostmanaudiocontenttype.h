...
#ifndef IQPOSTMANAUDIOCONTENTTYPE_H
#define IQPOSTMANAUDIOCONTENTTYPE_H

#include "iqpostmanabstractcontenttype.h"
#include "iqpostman_global.h"
#include <QHash>

class IQPOSTMANSHARED_EXPORT IqPostmanAudioContentType : public IqPostmanAbstractContentType
{
    Q_OBJECT
...
public:
    ...
    explicit IqPostmanAudioContentType(QObject *parent = Q_NULLPTR);
...
#endif // IQPOSTMANAUDIOCONTENTTYPE_H
