...
#ifndef IQPOSTMANVIDEOCONTENTTYPE_H
#define IQPOSTMANVIDEOCONTENTTYPE_H

#include "iqpostmanabstractcontenttype.h"
#include "iqpostman_global.h"
#include <QHash>

class IQPOSTMANSHARED_EXPORT IqPostmanVideoContentType : public IqPostmanAbstractContentType
{
    Q_OBJECT
...
public:
    ...
    explicit IqPostmanVideoContentType(QObject *parent = Q_NULLPTR);
...
#endif // IQPOSTMANVIDEOCONTENTTYPE_H
